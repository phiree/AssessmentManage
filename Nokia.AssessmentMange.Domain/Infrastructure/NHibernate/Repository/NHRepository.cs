...
namespace Nokia.AssessmentMange.Domain.Infrastructure.NHibernate.Repository
{
    public class NHRepositoryBase<TEntity,TPrimaryKey> : IRepository<TEntity, TPrimaryKey>
        where TEntity : IEntity<TPrimaryKey>
    {

        protected ISession session { get { return YunChuang.IdAccess.Infrastructure.NHibernate.UnitOfWork. NhUnitOfWork.Current.Session; } }
        ...
        public virtual TEntity FindById(TPrimaryKey identityId)
        {
            TEntity result;

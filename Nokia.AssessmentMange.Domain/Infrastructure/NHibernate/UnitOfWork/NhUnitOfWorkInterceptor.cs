...
using YunChuang.Core.Infrastructure;
using YunChuang.Core.DomainModel;
using YunChuang.Common;
using YunChuang.IdAccess.DomainModel.Repository;

namespace Nokia.AssessmentMange.Domain.Infrastructure.NHibernate.Repository.UnitOfWork
{
    /// <summary>
